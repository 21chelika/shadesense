...
<nav class="bg-rose-100 ">
    ...
    <section class="mt-5 flex justify-center w-full ">
        <a href="./auth/login.php"><button class="bg-rose-300 text-white h-10 text-xs rounded-full w-72 border px-9 pr-3 " type="submit">CHECK YOUR UNDERTONE HERE</button></a>   
    </section>
