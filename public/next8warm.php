...
<section class=" flex flex-row justify-between">
  ...
  <div class="relative w-full h-full flex items-center justify-center">
    <div class="absolute top-1/2 left-0" style="margin-top: 500px;">
    <a href="./next5cool.php" style="position: relative; display : inline-block;">
...
<section class="mt-5 flex justify-center w-full">
  <div class=" block mt-2">
    ...
    <a href="start6cool.php"><button class="bg-rose-300 text-white p-5 h-10 rounded-full w-72 border py-2 pr-3 sm:text-sm" type="submit">START</button>
    </a>
  </div>
</section>
</div>
