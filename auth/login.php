...
<body >
    <nav class="bg-rose-100 ">
      ...
      <!-- section 1 -->
        ...
        <section class="mt-5 flex justify-center w-full">
          <form action="proses_login.php" method="POST" class="block w-72 h-auto">
            ...
            <div class="relative block mt-5">
              <a href="./next5cool.php"><button class="bg-rose-300 text-white p-5 h-10 rounded-full w-72 border py-2  pr-3 sm:text-sm" type="submit">LOGIN</button></a>
            </div>
        ...
        <section class="mt-5 flex justify-center w-full ">
          <div class="block">
          <a href="./sign.php"> <a href="" class="font-normal text-sm">Forgot Password?</a>
        </div>
        </section> 
</body>
</html>