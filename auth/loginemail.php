      ...
      <section class=" flex justify-center w-full">
        <div class="block w-72 h-auto">
          ...
          <section class="mt-5 flex justify-center w-full">
            <div class="block">
            <a href="shadesense-main/auth/login.php"><button class="bg-rose-300 text-white p-5 h-10 rounded-full w-72 border py-2 pr-3 sm:text-sm" type="submit">LOGIN WITH EMAIL</button>
            </div>
          </section>
